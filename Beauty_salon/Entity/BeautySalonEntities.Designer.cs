// Создание кода T4 для модели "C:\Учеба 2\Инструментальные средства разработки программного обеспечения\Салон красоты - клиенты\Beauty_salon\Beauty_salon\Entity\BeautySalonEntities.edmx" включено. 
